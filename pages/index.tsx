...
const PricingCard = () => {
  return (
    <div className="w-full h-full">
      <div className="space-y-5 px-8 py-12 flex justify-start items-center">
        <div className="flex-row-reverse flex w-[1728x] w-[1728px] items-center justify-between">
          <div className="flex flex-col justify-center items-end w-[1352] w-[1352px]">
          ...
          <div className="border-[1px] border-gray-200 relative rounded-[32] rounded-t-lg py-[8] py-[4] px-[6] py-[16] my-3 p-4 rounded-br-lg rounded-bl-lg w-[320] h-[270] w-[318] h-[262] h-[262] h-[300] h-[362] h-[86] h-[336] flex bg-[#172D4C] h-[728px] w-64 justify-center items-end">
            <div className="flex flex-col gap-y-0 w-52 h-[784px] justify-end items-center">
              <div className="h-full z-10 relative grow w-fit h-[1171] flex justify-center items-center">
                <div className="my-0.5 flex justify-evenly flex-col gap-y-0.5 h-96">
                  <div className="flex flex-col flex-1 gap-y-2 w-full justify-center items-center h-[386px]">
                    <div className={"flex justify-between flex-col"}>
                      <div className={"flex grow gap-x-8 justify-between"}>
                        <div
                          className={
                            "md:text-2xl font-bold flex justify-between text-[#f8f8f8ff] text-sm"
                          }
                        >
                          <span className={"text-sm"}>Shadeform</span>
                        </div>
                      </div>
                      <div className={""}>
                        <ul className={"space-y-2 pt-8"}>
                          <li className="flex font-medium space-x-2 text-white justify-start items-center py-[8pxx] px-4 py-2">
                            <span className={"text-xs"}>VMs</span>
                          </li>
                          <li className="flex font-medium space-x-2 text-white justify-start items-center px-[16x] px-4 py-2">
                            <span className={"text-xs"}>Models</span>
                          </li>
                          <li className="flex font-medium space-x-2 text-white px-4 py-2 justify-start items-center">
                            <span className={"text-xs"}>Running Instances</span>
                          </li>
                          <li className="flex font-medium space-x-2 text-white justify-start items-center px-4 py-2">
                            <span className={"text-xs"}>
                              Scheduled Instances
                            </span>
                          </li>
                          <li
                            className={
                              "flex items-center font-medium space-x-2 text-white"
                            }
                          ></li>
                          <li className="flex font-medium space-x-2 text-white justify-start items-center px-4 py-2">
                            <span className={"text-xs"}>100gbit ethernet</span>
                          </li>
                          <li className="flex font-medium space-x-2 w-full justify-start items-center px-4 py-2 text-[#464646ff] bg-white">
                            <span className={"text-xs"}>Volumes</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div className={"hidden"}>
                  <ul className={"space-y-2 pt-8"}>
                    <li
                      className={
                        "flex items-center font-medium space-x-2 text-black"
                      }
                    >
                      <svg
                        className={"h-4 w-4"}
                      ...
                      >
                        <path
                          d={
                            "M16.4444 3.03947C15.1056 2.37412 13.5965 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 11.6244 21.9793 11.2537 21.939 10.8889M9 11L12 14L22 4"
                          }
                          stroke={"currentColor"}
                          strokeWidth={"2"}
                          strokeLinecap={"round"}
                      ...
                      <span className={""}>Everything in Free</span>
                    </li>
                    <li
                      className={
                        "flex items-center font-medium space-x-2 text-black"
                    ...
                    >
                      ...
                      <span className={""}>5,000 events / month</span>
                    </li>
                    <li
                      className={
                        "flex items-center font-medium space-x-2 text-black"
